...
function ChatWindow() {
    const {prompt, setPrompt, reply, setReply, currThreadId, setPrevChats, setNewChat, historyClose, setHistoryClose, toggleTheme} = useContext(MyContext);
        ...
        <div className="chatWindow">
            ...
            </div>
            {
                ...
                <div className="dropDown">
                    <div className="dropDownItem" onClick={toggleTheme}><i class="fa-regular fa-moon"></i> Theme</div>
